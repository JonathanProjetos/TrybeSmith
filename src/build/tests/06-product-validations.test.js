...
describe('6 - Crie as validações dos produtos', function () {
    var _this = this;
    it('Será validado que o campo "name" é obrigatório', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
    ...
    it('Será validado que o campo "name" tem o tipo string', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send({
    ...
    it('Será validado que o campo "name" é uma string com mais de 2 caracteres', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send({
    ...
    it('Será validado que o campo "amount" é obrigatório', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send({
    ...
    it('Será validado que o campo "amount" tem o tipo string', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send({
    ...
    it('Será validado que o campo "amount" é uma string com mais de 2 caracteres', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send({
